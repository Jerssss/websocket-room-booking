...
public class ModifyReservationWindowModel {
    private ServerConnection serverConnection;

    public ModifyReservationWindowModel() {
        try {
    ...
    public List<Reservation> fetchAllReservations() {
        ...
        try {
            serverConnection.sendMessage("<Request><Type>fetch_reservations</Type></Request>"); // XML request
